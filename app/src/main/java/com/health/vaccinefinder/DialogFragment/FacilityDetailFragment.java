package com.health.vaccinefinder.DialogFragment;
...
public class FacilityDetailFragment extends DialogFragment {
    ...
    public static FacilityDetailFragment newInstance(String param1, String param2) {
